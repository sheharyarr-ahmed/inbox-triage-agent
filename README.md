...
pnpm -s test                      # 218 tests, offline, no network, no API key needed
```
...
tests/          8 suites, 218 tests, all offline
...
| [`docs/DECISIONS.md`](docs/DECISIONS.md) | 70 entries: every architectural choice with the alternatives considered |
